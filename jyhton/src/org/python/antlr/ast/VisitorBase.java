...
public abstract class VisitorBase<R> implements VisitorIF<R> {
    ...
    public R visitRelConnection(RelConnection node) throws Exception {
        R ret = unhandled_node(node);
        traverse(node);
        return ret; 
    }
    
    public R visitRelInsert(RelInsert node) throws Exception {
        R ret = unhandled_node(node);
        traverse(node);
        return ret; 
    }

    public R visitRelCommit(RelCommit node) throws Exception {
        R ret = unhandled_node(node);
        traverse(node);
        return ret; 
    }
