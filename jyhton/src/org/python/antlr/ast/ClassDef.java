...
public static final PyType TYPE = PyType.fromClass(ClassDef.class);
    ...
    // Should our class definition persist in the database. 
    private boolean relPersist = false; 
    public boolean relPersist() { return relPersist; }
    // Which connection do we use to persist too. 
    private Name connection_name = null;
    ...
    body, java.util.List<expr> decorator_list, boolean persist, Name conn_name) {
        super(token);
        this.name = name.getText();
        this.nameNode = name;
        this.bases = bases;
        this.relPersist = persist; 
