...
@ExposedType(name = "_ast.RelCommit", base = AST.class)
public class RelCommit extends expr implements Context {
    private Name connection_name; 
    public Name getConnectionName() { return connection_name; }

    public RelCommit(Integer ttype, Token token, Name conn_name) {
        super(ttype, token);
    ...
    public <R> R accept(VisitorIF<R> visitor) throws Exception {
        ...
        return visitor.visitRelCommit(this);
    }
