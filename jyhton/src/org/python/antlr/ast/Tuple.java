...
public static final PyType TYPE = PyType.fromClass(Tuple.class);
    ...
    // Added for ReL
    private Object ReLstring=null;
    private Object ReLmode  =null;
    // What connection are we going to try and use. 
    private Name connectionName = null;
    
    // end rell 
    public Object getInternalReLstring() {
       return ReLstring;
    }
    @ExposedGet(name = "ReLstring")
    public PyObject getReLstring() {
       return (PyObject)ReLstring;
    }
    @ExposedSet(name = "ReLstring")
    public void setRELSTRING(PyObject ReLString) {
       this.ReLstring = AstAdapters.py2string(ReLstring);
    }
    public Object getInternalReLmode() {
       return ReLmode;
    }
    // End ReL addition
...
// This constructor was added for ReL
    public Tuple(Integer ttype, Token token, java.util.List<expr> elts, expr_contextType ctx, 
                     java.util.List<String> strings, String mode, Name conn_name) {
        super(ttype, token);
        connectionName = conn_name; 
        //put all strings from antlr into big string to pass through
        String temp=";";
    ...
    public Name getConnectionName() { return connectionName; }
// End ReL addition
