...
public class JenaTutorialExamples {
	...
	public static String SERVER_URL = "http://172.16.18.134:10035";
//	public static String SERVER_URL = "http://ec2-52-10-0-189.us-west-2.compute.amazonaws.com:10035";
	...
	public static AGModel example2(boolean close) throws Exception {
	    String epeople = "http://example.org/people/";
	    String eontology = "http://example.org/ontology/";
	    // String epeople = ":";
	    // String eontology = ":";
		...
		Resource alice = model
				.createResource(epeople + "alice");
		Resource bob = model.createResource(epeople + "bob");
		Property name = model
				.createProperty(eontology + "name");
		Resource person = model
				.createResource(eontology + "Person");
	 ...
	 * A SPARQL Query
	 */
	public static ArrayList<ArrayList<String>> example3(String sparql_query) throws Exception {
	    ArrayList<ArrayList<String>> rows = new ArrayList<ArrayList<String>>();
		AGModel model = example2(false);
		println("\nStarting example3().");
		try {
			// String queryString = "SELECT ?s ?p ?o  WHERE {?s ?p ?o .}";
			String queryString = sparql_query;
		...
		try {
			for (Integer choice : choices) {
				...
				case 2:
					...
					break;
				case 3:
					example3("SELECT ?s ?p ?o  WHERE {?s ?p ?o .}");
					break;
				case 4:
					example4();
					break;
