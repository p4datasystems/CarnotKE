...
class OracleNoSQLTestCase_SIM_select(unittest.TestCase):
    def runTest(self):
        ...
        assert sorted(results) == [(7566, 7788, 'NULL', 'SCOTT', 20, 'TO_DATE(09-DEC-1982, DD-MON-YYYY)', 3000, 'ANALYST'), (7566, 7902, 'NULL', 'FORD', 20, 'TO_DATE(3-DEC-1981, DD-MON-YYYY)', 3000, 'ANALYST'), (7698, 7499, 300, 'ALLEN', 30, 'TO_DATE(20-FEB-1981, DD-MON-YYYY)', 1600, 'SALESMAN'), (7698, 7521, 500, 'WARD', 30, 'TO_DATE(22-FEB-1981, DD-MON-YYYY)', 1250, 'SALESMAN'), (7698, 7654, 1400, 'MARTIN', 30, 'TO_DATE(28-SEP-1981, DD-MON-YYYY)', 1250, 'SALESMAN'), (7698, 7844, 'NULL', 'TURNER', 30, 'TO_DATE(8-SEP-1981, DD-MON-YYYY)', 1500, 'SALESMAN'), (7698, 7900, 'NULL', 'JAMES', 30, 'TO_DATE(3-DEC-1981, DD-MON-YYYY)', 950, 'CLERK'), (7782, 7934, 'NULL', 'MILLER', 50, 'TO_DATE(23-JAN-1982, DD-MON-YYYY)', 1300, 'CLERK'), (7788, 7876, 'NULL', 'ADAMS', 20, 'TO_DATE(12-JAN-1983, DD-MON-YYYY)', 1100, 'CLERK'), (7839, 7566, 'NULL', 'JONES', 20, 'TO_DATE(2-APR-1981, DD-MON-YYYY)', 2975, 'MANAGER'), (7839, 7698, 'NULL', 'BLAKE', 30, 'TO_DATE(1-MAY-1981, DD-MON-YYYY)', 2850, 'MANAGER'), (7839, 7782, 'NULL', 'CLARK', 10, 'TO_DATE(9-JUN-1981, DD-MON-YYYY)', 2450, 'MANAGER'), (7902, 7369, 'NULL', 'SMITH', 20, 'TO_DATE(17-DEC-1980, DD-MON-YYYY)', 800, 'CLERK'), ('NULL', 7839, 'NULL', 'KING', 10, 'TO_DATE(17-NOV-1981, DD-MON-YYYY)', 5000, 'PRESIDENT'), ('mgr', 'empno', 'comm', 'ename', 'deptno', 'hiredate', 'sal', 'job')], 'OracleNoSQLTestCase_SIM_select query failed'
