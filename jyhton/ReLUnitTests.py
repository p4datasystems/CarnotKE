...
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7521, ENAME : 'WARD', JOB : 'SALESMAN', MGR : 7698, HIREDATE : '22-FEB-81', SAL : 1250, COMM : 500, DEPTNO : 30})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7566, ENAME : 'JONES', JOB : 'MANAGER', MGR : 7839, HIREDATE : '02-APR-81', SAL : 2975, COMM : 0, DEPTNO : 20})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7654, ENAME : 'MARTIN', JOB : 'SALESMAN', MGR : 7698, HIREDATE : '28-SEP-81', SAL : 1250, COMM : 1400, DEPTNO : 30})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7698, ENAME : 'BLAKE', JOB : 'MANAGER', MGR : 7839, HIREDATE : '01-MAY-81', SAL : 2850, COMM : 0, DEPTNO : 30})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7782, ENAME : 'CLARK', JOB : 'MANAGER', MGR : 7839, HIREDATE : '09-JUN-81', SAL : 2450, COMM : 0, DEPTNO : 10})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7788, ENAME : 'SCOTT', JOB : 'ANALYST', MGR : 7566, HIREDATE : '09-DEC-82', SAL : 3000, COMM : 0, DEPTNO : 20})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7839, ENAME : 'KING', JOB : 'PRESIDENT', MGR : 0, HIREDATE : '17-NOV-81', SAL : 5000, COMM : 0, DEPTNO : 10})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7844, ENAME : 'TURNER', JOB : 'SALESMAN', MGR : 7698, HIREDATE : '08-SEP-81', SAL : 1500, COMM : 0, DEPTNO : 30})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7876, ENAME : 'ADAMS', JOB : 'CLERK', MGR : 7788, HIREDATE : '12-JAN-83', SAL : 1100, COMM : 0, DEPTNO : 20})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7900, ENAME : 'JAMES', JOB : 'CLERK', MGR : 7698, HIREDATE : '03-DEC-81', SAL : 950, COMM : 0, DEPTNO : 30})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7902, ENAME : 'FORD', JOB : 'ANALYST', MGR : 7566, HIREDATE : '03-DEC-81', SAL : 3000, COMM : 0, DEPTNO : 20})"
Neo4j on connOracleRDFNoSQL "CREATE (:emp { EMPNO : 7934, ENAME : 'MILLER', JOB : 'CLERK', MGR : 7782, HIREDATE : '23-JAN-82', SAL : 1300, COMM : 0, DEPTNO : 50})"
...
class SIMTestCase_2(unittest.TestCase):
    def runTest(self):
...
class OracleNoSQLTestCase_SIM_select(unittest.TestCase):
    def runTest(self):
        ...
        assert sorted(results) == [(0, 7839, 0, 'KING', 10, '17-NOV-81', 5000, 'PRESIDENT'), (7566, 7788, 0, 'SCOTT', 20, '09-DEC-82', 3000, 'ANALYST'), (7566, 7902, 0, 'FORD', 20, '03-DEC-81', 3000, 'ANALYST'), (7698, 7499, 300, 'ALLEN', 30, '20-FEB-81', 1600, 'SALESMAN'), (7698, 7521, 500, 'WARD', 30, '22-FEB-81', 1250, 'SALESMAN'), (7698, 7654, 1400, 'MARTIN', 30, '28-SEP-81', 1250, 'SALESMAN'), (7698, 7844, 0, 'TURNER', 30, '08-SEP-81', 1500, 'SALESMAN'), (7698, 7900, 0, 'JAMES', 30, '03-DEC-81', 950, 'CLERK'), (7782, 7934, 0, 'MILLER', 50, '23-JAN-82', 1300, 'CLERK'), (7788, 7876, 0, 'ADAMS', 20, '12-JAN-83', 1100, 'CLERK'), (7839, 7566, 0, 'JONES', 20, '02-APR-81', 2975, 'MANAGER'), (7839, 7698, 0, 'BLAKE', 30, '01-MAY-81', 2850, 'MANAGER'), (7839, 7782, 0, 'CLARK', 10, '09-JUN-81', 2450, 'MANAGER'), (7902, 7369, 0, 'SMITH', 20, '17-DEC-80', 800, 'CLERK'), ('mgr', 'empno', 'comm', 'ename', 'deptno', 'hiredate', 'sal', 'job')], 'OracleNoSQLTestCase_SIM_select query failed'
